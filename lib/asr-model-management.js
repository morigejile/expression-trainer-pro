...
const SAFE_MESSAGES = Object.freeze({
  ...
  'asr-install-model-mismatch': 'A different ASR model is being installed',
  'asr-model-install-failed': 'ASR model install failed',
  'asr-model-install-process-exited': 'ASR model install process exited',
  'asr-model-install-cancelled': 'ASR model install cancelled'
});
