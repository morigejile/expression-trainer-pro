...
function createModelManager({
  ...
  if (modelRoot !== undefined && (typeof modelRoot !== 'string' || !path.isAbsolute(modelRoot))) throw new Error('modelRoot must be an absolute path');
  ...
  const modelsRoot = modelRoot ?? path.join(userDataPath, 'models');
