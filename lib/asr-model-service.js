...
function createAsrModelService({
  ...
  function snapshot() {
    const controllerState = typeof currentController?.snapshot === 'function'
      ? currentController.snapshot()
      : {};
    return Object.freeze({
      ...
      recoveryNotice,
      lastErrorCode,
      lastInitializationElapsedMs: controllerState.lastInitializationElapsedMs ?? null,
      lastErrorCategory: controllerState.lastErrorCategory ?? lastErrorCode
    });
  }
