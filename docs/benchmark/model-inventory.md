...
Zipformer Large is a distinct verified benchmark candidate. Its archive matches the official digest; runtime files total 162,311,515 bytes. Sherpa-ONNX 1.13.3 native online initialization and the BM-03 100-sample run passed on Windows x64. It is not yet a selected product default, packaged model, or redistribution-approved artifact.
