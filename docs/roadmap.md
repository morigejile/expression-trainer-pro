...
> 更新日期：2026-08-31
> 当前进度：Phase 0-5 的内部基线、R-01～R-09、PKG-01～PKG-04、OPS-02/OPS-05、七候选 benchmark、CONV-01～CONV-03 与 ASR-M01～M03 已完成。ASR-M04 仍受许可和公开制品条件约束。
...
R-01～R-09、D-03/D-04、PKG-01～PKG-04、BM-04 与 ASR-M01～M03 已完成当前最小边界。产品会恢复独立持久选择，无选择时采用 Zipformer Large 技术默认；设置页通过脱敏快照与四个受限命令管理下载、取消、重试和切换，安装任务独立于当前识别 controller。公开分发仍取决于许可与产品链路验收。
...
ADR-0009 已采用 Zipformer Large 作为技术默认；ASR-M02 已接入启动恢复，旧 Paraformer 安装继续保留；ASR-M03 已完成设置页切换入口与独立安装任务。包内默认、升级资格验证和再分发授权仍属于 ASR-M04。
...
| M7 新需求产品化 | In Progress | UI-01～UI-02、ASR-M01～ASR-M04（ASR-M01～M03 Completed） | 三款 streaming Catalog/Factory、选择/单 controller 服务及安装设置入口已完成；响应式外观与公开默认模型条件继续分轨交付 |
